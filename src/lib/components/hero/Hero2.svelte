<script lang="ts">
	...
	export let greetings: string = 'Your Greeting here';
	export let name: string = 'Your Name here';
	export let description: string = 'Your Description here';
</script>
...
<section class="body-font">
	<div class="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
		...
		<div class="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
			<h1 class="title-font lg:text-8xl md:text-6xl text-4xl mb-2 font-medium">
				{greetings}
			</h1>
			<h1 class="title-font lg:text-8xl md:text-6xl text-4xl mb-4">
			...
			<div class="flex w-full justify-center items-end">
				<div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
					<!-- <label for="hero-field" class="leading-7 text-sm">Have an app idea?</label> -->
					<input
						type="text"
						id="hero-field"
						name="hero-field"
						class="w-full rounded border bg-opacity-40 border-gray-700 focus:ring-2 focus:ring-green-900 focus:bg-transparent focus:border-green-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
