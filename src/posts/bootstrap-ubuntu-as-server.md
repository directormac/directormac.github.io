...
![aftergrub](/assets/ubuntu/aftergrub.png)
...
![languageselect](/assets/ubuntu/languageselect.png)
...
![installerupdate](/assets/ubuntu/installerupdate.png)
...
![keyboardlayout](/assets/ubuntu/keyboardlayout.png)
...
![ubuntuselection](/assets/ubuntu/ubuntuselection.png)
...
![networkconnections](/assets/ubuntu/networkconnections.png)
...
![staticipmenu](/assets/ubuntu/staticipmenu.png)

2. A new popup below will show you what `IPv4 Method` you want to use press `enter`, you are in this section
   so select `Manual`

![ipv4method](/assets/ubuntu/ipv4method.png)
![ipv4methodmanual](/assets/ubuntu/ipv4methodmanual.png)
...
![ipv4methodset](/assets/ubuntu/ipv4methodset.png)

For reference here is what i entered while doing this guide

![ipv4methodexplain](/assets/ubuntu/ipv4methodexplain.png)

</details>

<details><summary>Network Setup Done</summary>

![ipv4methoddone](/assets/ubuntu/ipv4methoddone.png)
...
![mirror](/assets/ubuntu/mirror.png)
...
![storage](/assets/ubuntu/storage.png)
...
![storage](/assets/ubuntu/storageconfig.png)
...
![storagedone](/assets/ubuntu/storagedone.png)
...
![profile](/assets/ubuntu/profile.png)

</details>

<details><summary>Fill up Profile</summary>

![profiledone](/assets/ubuntu/profiledone.png)
...
![ubuntupro](/assets/ubuntu/ubuntupro.png)
...
![openssh](/assets/ubuntu/openssh.png)
![opensshcheck](/assets/ubuntu/opensshcheck.png)
...
![featuredsnaps](/assets/ubuntu/featuredsnaps.png)
...
![complete](/assets/ubuntu/complete.png)
![completelog](/assets/ubuntu/completelog.png)
![completereboot](/assets/ubuntu/completereboot.png)
...
![firstboot](/assets/ubuntu/firstboot.png)
![ready](/assets/ubuntu/ready.png)
...
![sshlogin](/assets/ubuntu/sshlogin.png)
...
![afterupgrade](/assets/ubuntu/afterupgrade.png)
...
![installdocker](/assets/ubuntu/installdocker.png)
![installdockerdone](/assets/ubuntu/installdockerdone.png)
...
![dockerps](/assets/ubuntu/installdockerps.png)
...
![portainerrun](/assets/ubuntu/portainerrun.png)
...
![portainerup](/assets/ubuntu/portainerup.png)
...
![postgresvolume](/assets/ubuntu/postgresvolume.png)
...
![postgresrun](/assets/ubuntu/postgresrun.png)
...
![posgresnetwork](/assets/ubuntu/postgresnetwork.png)
...
5. Additional optins on portainer settings we could have done it on the commands above but
   ...
   - Live connect to your local instance check containers and you will see the following
     ![postgrescontainer](/assets/ubuntu/postgrescontainer.png)
   ...
   - On `RESTART_POLICIES` where the default is set to `none` change it to _`always`_
     ![postgresrestart](/assets/ubuntu/postgresrestart.png)
...
I will update this post more with more examples
